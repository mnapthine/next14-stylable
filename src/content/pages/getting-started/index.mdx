...
Shelley is a headless (unstyled) component library for React that leverages Adobes react-aria hooks to maintain accessibility standards and [Stylable](https://stylable.io) as its styling solution.
...
There is nothing stopping you from using atomic/utility classes for some alignment but if you want full blown [tailwind](https://tailwindui.com/) then more composable libraries like [Adobe's React Aria](https://react-spectrum.adobe.com/react-aria/components.html) (using the same hooks) are gonna be a better fit for you.
