...
We generally assume that you will be using Typescript with Shelley and Stylable and suggest you check out [Stylable's Typescript Integration docs](https://stylable.io/docs/getting-started/typescript-integration).
